...
<script type="text/javascript" src="<?php echo STATIC_DIR;?>js.php?lynx"></script>
...
dtemplate+= "<img src='<?php echo IMAGE_DIR;?>idmdl.gif' \/><\/a>((filesize))<\/td>";
...
<span><label><input type="checkbox" id="flist_match_ins" /><?php echo $L->say['match_csensitive'];?></label>
...
<script type="text/javascript">var dwindow = '<?php echo '_'.substr(md5(TIME_NOW),0,7).'_'; ?>'; var Opt = new Array(); Opt = {"nC" : "<?php echo $c;?>", "AdL" : "<?php echo $options["auto_del_time"]; ?>", "DelLink" : <?php echo ($lynx_del ? "true" : "false");?>};</script>
...
<?php }?>
<label><input type="checkbox" name="add_comment" id="add_comment" onclick="javascript:GenTag();" />&nbsp;<a onclick="javascript:var diq=d.getElementById('add_comment');if(!diq.checked){diq.checked=true;}GenTag();"><u><?php echo $L->say['_genlink'];?></u></a></label>
</td></tr>
