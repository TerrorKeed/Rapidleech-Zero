...
<?php 
	        $post['log'] = $_REQUEST['my_login'];
            $post['pas'] = $_REQUEST['my_pass'];
			$post['inout'] = "%D0%92%D1%85%D0%BE%D0%B4";
			
            $page = geturl("wm.letitbit.net", 80, "/wm-panel/User/signin-do/", 0, 0, $post);
			is_page($page);
