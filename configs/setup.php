...
<link rel="stylesheet" href="<?php echo ROOT_URL . CONFIG_DIR;?>css/setup.css" type="text/css" />
</head>
<body class="install-body">
<div class="container">
<div class="head_container">
<h1 id="logo"><img alt="Rapidleech" src="<?php echo ROOT_URL.IMAGE_DIR;?>rl_lgo.png" /></h1>
</div>
<?php
if(isset($_POST["step"]) && $_POST["step"]=="1"){
   ...
   if($ret_copy){
    ...
    echo '<center><input type="submit" onclick="location.href=\''.ROOT_URL.$options['index_file'].'\';" value="Let&#8217;s rock n&#8217; roll!" class="button"/></center></p>';
   }else{
...
<form action="<?php echo ROOT_URL.$options["index_file"];?>" method="post">
