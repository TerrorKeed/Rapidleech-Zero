...
switch($vpage)
{
  ...
  //http.php; it's load from index.php also
     ...
     '_max_filesize' => 'MAX tamanho files:',
     '_min_filesize' => 'MIN tamanho files:',
...
//Additional language for RAR/UNRAR
     'rar_error'      => 'Erro detectado',
     'rar_expand'       => 'Clique aqui para ampliar',
     'rar_window'       => 'Voc&ecirc; pode arrastar a janela daqui',
     'rar_disappear'		=> 'N&atilde;o &eacute; poss&iacute;vel encontrar &quot;rar&quot;<br />Voc&ecirc; pode precisar fazer o download e extrair &quot;rar&quot; para o diret&oacute;rio &quot;/rar/&quot;',
     '_filearcv'		=> 'Os arquivos que ser&atilde;o arquivados:',
     '_namearcv'      => 'Nome do arquivo:',
     '_raropt'      => 'Op&ccedil;&otilde;es:',  
     '_rarcpr'		=> 'N&iacute;vel de compress&atilde;o:',
     '_store'     => 'Armazenar',
     '_fastest'      =>	'Mais r&aacute;pido',
     '_fast'      =>	'R&aacute;pido',
     '_normal'      =>	'Normal',
     '_good'      =>	'Bom',
     '_best'      =>	'&Oacute;timo',
     '_volumes'     =>	'Criar volumes',
     '_delarcv'      => 'Excluir arquivos ap&oacute;s arquivamento',
     '_solarcv'      =>	'Criar arquivo s&oacute;lido',
     '_recarcv'      =>	'Criar um registro de recupera&ccedil;&atilde;o',
     '_testarcv'      =>	'Teste de arquivo ap&oacute;s a compress&atilde;o',
     '_pasarcv'       => 'Use a senha',
     '_encarcv'	      =>	'Criptografar os nomes de arquivo',
     '_patharcv'      =>	'Definir o caminho dentro de arquivo',
     '_rar'	      =>	'Rar',
     '_crearcv'	      =>	'Cria&ccedil;&atilde;o do arquivo: <b>%1$s</b>',
     '_wait'      =>	'Aguarde...',
     '_backlist'      =>	'Voltar para a lista de arquivos',
     '_filefr'      =>	'<b>Arquivos de %1$s</b>:',
     '_unrar'	      =>	'N&atilde;o &eacute; poss&iacute;vel encontrar "unrar"',
     '_passlist'	      =>	'Senha necess&aacute;ria para listar os arquivos:',
     '_passext'	      =>	'Senha necess&aacute;ria para extrair os arquivos:',
     '_unrarerr'      =>	'Erro:%1$s',
     '_trylist'	      =>	'Tente novamente listar',
     '_unrarsel'	      =>	'Unrar selecionados',
     '_extracting'	      =>	'<b>Extracting files from %1$s</b>:',
     '_stat'      =>	'Status:',
     '_text'		=> 'Selecione o texto',
     '_separcv'	      =>	'Coloque cada arquivo em um arquivo separado',
