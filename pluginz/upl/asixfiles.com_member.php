...
<tr><td align=center>
<div id=login width=100% align=center>Login to asixfiles.com</div>
<?php
			$post['op'] = "login" ;
			$post['redirect'] = "" ;
			...
			$post['x'] = "0" ;
			$post['y'] = "0" ;
			$page = geturl("asixfiles.com", 80, "/login.html", 0, 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("asixfiles.com", 80, "/?op=my_files", "http://asixfiles.com/login.html", $cookies, 0, 0, "");
			is_page($page);
