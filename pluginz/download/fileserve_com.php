...
if ((
        $_GET["premium_acc"] == "on" && $_GET["premium_user"] && $_GET["premium_pass"]) || ($_GET["premium_acc"] == "on" && $premium_acc["fileserve"]["user"] && $premium_acc["fileserve"]["pass"])) {
    $user = ($_GET["premium_user"] ? $_GET["premium_user"] : $premium_acc["fileserve"]["user"]);
    $pass = ($_GET["premium_pass"] ? $_GET["premium_pass"] : $premium_acc["fileserve"]["pass"]);
