...
class letitbit_net extends DownloadClass {
    ...
    public function Download($link) {
        ...
        } elseif ($_REQUEST['premium_acc'] == 'on' && (($_REQUEST['premium_pass'])||(!empty($premium_acc['letitbit_net']['key'])))) {
            $key = ($_REQUEST ["premium_pass"] ? trim($_REQUEST ["premium_pass"]) : $premium_acc["letitbit_net"]["key"]);
