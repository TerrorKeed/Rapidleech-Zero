...
if ($mega_login && $mega_pass){
	$_REQUEST['up_login'] = $mega_login;
	$_REQUEST['up_pass'] = $mega_pass;
	$_REQUEST['action'] = "FORM";
	echo "<b><center>Use Default login/pass.</center></b>\n";
} elseif (isset($upload_acc) && isset($upload_acc["mu_pre"]["user"]) && $upload_acc["mu_pre"]["user"] != '' && $upload_acc["mu_pre"]["pass"] != '') {
    $_REQUEST['up_login'] = $upload_acc["mu_pre"]["user"];
    $_REQUEST['up_pass'] = $upload_acc["mu_pre"]["pass"];
    $_REQUEST['action'] = "FORM";
    echo "<b><center>Use Default login/pass.</center></b>\n";
}
