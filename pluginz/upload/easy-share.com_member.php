...
} elseif (isset($upload_acc) && isset($upload_acc["easysh_mem"]["user"]) && $upload_acc["easysh_mem"]["user"] != '' && $upload_acc["easysh_mem"]["pass"] != '') {
    $_REQUEST['my_login'] = $upload_acc["easysh_mem"]["user"];
    $_REQUEST['my_pass'] = $upload_acc["easysh_mem"]["pass"];
    $_REQUEST['action'] = "FORM";
    echo "<b><center>Use Default easy-share.com login/pass.</center></b>\n";
}
