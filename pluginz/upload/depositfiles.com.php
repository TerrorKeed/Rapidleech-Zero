...
} elseif (isset($upload_acc) && isset($upload_acc["deposit_up"]["user"]) && $upload_acc["deposit_up"]["user"] != '' && $upload_acc["deposit_up"]["pass"] != '') {
    $_REQUEST['my_login'] = $upload_acc["deposit_up"]["user"];
    $_REQUEST['my_pass'] = $upload_acc["deposit_up"]["pass"];
    $_REQUEST['action'] = "FORM";
    echo "<b><center>Use Default login/pass.</center></b>\n";
}
