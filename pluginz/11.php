...
{
	$post = Array();
	$post["lc_email"] = (($_GET["pr_user"] && $_GET["pr_pass"]) ? $_GET["pr_user"] : $premium_acc["megashares"]["user"]);
	$post["lc_pin"] = (($_GET["pr_user"] && $_GET["pr_pass"]) ? $_GET["pr_pass"] : $premium_acc["megashares"]["pass"]);
	...
	is_present_tryagain($page, "Failed login message:", "Wrong username or password");
