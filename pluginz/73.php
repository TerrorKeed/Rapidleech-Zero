...
<?php   
	...
	function downloadNotSupported( $link )
	{
	...
	function login( $user, $password )
	{
		...
		else
		{
			...
			$page = GetPage( $loginURL, $cook, $post, $Referer );
			$cookie = GetCookies( $page );
			
			is_present( $page, 'login failed', 'Login Failed, please try again!' );

			$page = GetPage( 'http://torrific.com/home/', $cookie, 0, $Referer );
