...
$msg = "Powered by OLC";
$VERSION = '<small style="color:#239FD9"><b>[ <a href="http://ocean-leecher.net/forum/index.php" target="_blank">olc</a> :: <a href="javascript:;" title="room #14">ccpb</a> :: <a href="http://kaskus.us/" target="_blank">kaskus</a> ]</b></small>';

function notexist() {
	global $msg, $VERSION, $RL_VER, $options, $L;
	echo "<html><head><title>:: ".$RL_VER." ::</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=".($charSet!="" ? $charSet : "utf-8")."\"><style type=\"text/css\"><!--@import url(\"".IMAGE_DIR."style_sujancok".$options["csstype"].".css\");--></style></head><body><br /><h1>".$RL_VER.": NoP</h1><center><b class='r'>".$L->say['_inexist']."</b><br /><br /><hr style='width:500;' />".$msg."<br />".$VERSION."</center></body></html>";
	exit ();
}
...
<div id="del_container">
  <form name="frm_delete" action="<?php echo ROOT_URL.basename($PHP_SELF)."?d=".$_GET['d']; ?>" method="post">
