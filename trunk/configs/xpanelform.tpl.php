...
<tr>
<td class="tdacc"><input type="checkbox" id=dirchange name="dirchange"<?php if($showpostn){if(isset($_POST['dirchange']) && $_POST['dirchange']=='on')echo ' checked="checked"';}elseif($options['download_dir_is_changeable']) echo ' checked="checked"'; ?>><label for=dirchange>&nbsp;Download Directory is changeable</label></td>
<td class="tdacc">Don't check this to disallow users to change the download directory!</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id="dirchangeaudl" name="dirchangeaudl"<?php if($showpostn){if(isset($_POST['dirchangeaudl']) && $_POST['dirchangeaudl']=='on')echo ' checked="checked"';}elseif($options['maysaveto']) echo ' checked="checked"'; ?>><label for="dirchangeaudl">&nbsp;Download Dir is changeable&nbsp;(audl.php)</label></td>
...
<tr>
<td class="tdacc"><input type="checkbox" id=showallfiles name="showallfiles"<?php if($showpostn){if(isset($_POST['showallfiles']) && $_POST['showallfiles']=='on')echo ' checked="checked"';}elseif($options['show_all']) echo ' checked="checked"'; ?>><label for=showallfiles>&nbsp;Show all files</label></td>
...
<li class="ndot">
<input type="checkbox" id="act_upload" name="act_upload"<?php if($showpostn){if(isset($_POST['act_upload']) && $_POST['act_upload']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_upload"]) echo ' checked="checked"'; ?>><label for="act_upload">&nbsp;Disable Upload</label></li>
<li class="ndot">
<input type="checkbox" id="act_ftp" name="act_ftp"<?php if($showpostn){if(isset($_POST['act_ftp']) && $_POST['act_ftp']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_ftp"]) echo ' checked="checked"'; ?>><label for=act_ftp>&nbsp;Disable Ftp</label></li>
<li class="ndot">
<input type="checkbox" id="act_mail" name="act_mail"<?php if($showpostn){if(isset($_POST['act_mail']) && $_POST['act_mail']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_mail"]) echo ' checked="checked"'; ?>><label for=act_mail>&nbsp;Disable Email</label></li>
<li class="ndot">
<input type="checkbox" id="act_boxes" name="act_boxes"<?php if($showpostn){if(isset($_POST['act_boxes']) && $_POST['act_boxes']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_boxes"]) echo ' checked="checked"'; ?>><label for=act_boxes>&nbsp;Disable Mass Submits</label></li>
<li class="ndot">
<input type="checkbox" id="act_split" name="act_split"<?php if($showpostn){if(isset($_POST['act_split']) && $_POST['act_split']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_split"]) echo ' checked="checked"'; ?>><label for=act_split>&nbsp;Disable Split</label></li>
<li class="ndot">
<input type="checkbox" id="act_merge" name="act_merge"<?php if($showpostn){if(isset($_POST['act_merge']) && $_POST['act_merge']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_merge"]) echo ' checked="checked"'; ?>><label for=act_merge>&nbsp;Disable Merge</label></li>
<li class="ndot">
<input type="checkbox" id="act_md5" name="act_md5"<?php if($showpostn){if(isset($_POST['act_md5']) && $_POST['act_md5']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_md5"]) echo ' checked="checked"'; ?>><label for=act_md5>&nbsp;Disable MD5 / Changer</label></li>
<li class="ndot">
<input type="checkbox" id="act_pack" name="act_pack"<?php if($showpostn){if(isset($_POST['act_pack']) && $_POST['act_pack']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_pack"]) echo ' checked="checked"'; ?>><label for=act_pack>&nbsp;Disable Pack</label></li>
<li class="ndot">
<input type="checkbox" id="act_zip" name="act_zip"<?php if($showpostn){if(isset($_POST['act_zip']) && $_POST['act_zip']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_zip"]) echo ' checked="checked"'; ?>><label for=act_zip>&nbsp;Disable Zip</label></li>
<li class="ndot">
<input type="checkbox" id="act_unzip" name="act_unzip"<?php if($showpostn){if(isset($_POST['act_unzip']) && $_POST['act_unzip']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_unzip"]) echo ' checked="checked"'; ?>><label for=act_unzip>&nbsp;Disable UnZip</label></li>
<li class="ndot">
<input type="checkbox" id="act_rar" name="act_rar"<?php if($showpostn){if($_POST['act_rar']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_rar"]) echo ' checked="checked"'; ?>><label for=act_rar>&nbsp;Disable RAR Files</label></li>
<li class="ndot">
<input type="checkbox" id="act_unrar" name="act_unrar"<?php if($showpostn){if($_POST['act_unrar']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_unrar"]) echo ' checked="checked"'; ?>><label for=act_unrar>&nbsp;Disable UnRAR Files</label></li>
<li class="ndot">
<input type="checkbox" id="act_rename" name="act_rename"<?php if($showpostn){if(isset($_POST['act_rename']) && $_POST['act_rename']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_rename"]) echo ' checked="checked"'; ?>><label for=act_rename>&nbsp;Disable Rename</label></li>
<li class="ndot">
<input type="checkbox" id="act_mrename" name="act_mrename"<?php if($showpostn){if(isset($_POST['act_mrename']) && $_POST['act_mrename']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_mrename"]) echo ' checked="checked"'; ?>><label for=act_mrename>&nbsp;Disable Mass-Rename</label></li>
<li class="ndot">
<input type="checkbox" id="act_delete" name="act_delete"<?php if($showpostn){if(isset($_POST['act_delete']) && $_POST['act_delete']=='on')echo ' checked="checked"';}elseif($options['disable_to']["act_delete"]) echo ' checked="checked"'; ?>><label for=act_delete>&nbsp;Disable Delete</label></li>
</div>
</td>
...
<div class="div_left_ndot"><ul>
<li class="ndot">
	<input type="checkbox" id="md5" name="md5"<?php if($showpostn){if(isset($_POST['md5']) && $_POST['md5']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["md5"]) echo ' checked="checked"'; ?>><label for="md5">&nbsp;Show MD5</label></li>
<li class="ndot">
	<input type="checkbox" id="downloadlink" name="downloadlink"<?php if($showpostn){if(isset($_POST['downloadlink']) && $_POST['downloadlink']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["downloadlink"]) echo ' checked="checked"'; ?>><label for="downloadlink">&nbsp;Show Download_Link</label></li>
<li class="ndot">	
	<input type="checkbox" id="comments" name="comments"<?php if($showpostn){if(isset($_POST['comments']) && $_POST['comments']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["comments"]) echo ' checked="checked"'; ?>><label for="comments">&nbsp;Show Comments</label></li>
<li class="ndot">	
	<input type="checkbox" id="date" name="date"<?php if($showpostn){if(isset($_POST['date']) && $_POST['date']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["date"]) echo ' checked="checked"'; ?>><label for="date">&nbsp;Show Date</label></li>
<li class="ndot">	
	<input type="checkbox" id="age" name="age"<?php if($showpostn){if(isset($_POST['age']) && $_POST['age']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["age"]) echo ' checked="checked"'; ?>><label for="age">&nbsp;Show Age</label></li>
<li class="ndot">	
	<input type="checkbox" id="ip" name="ip"<?php if($showpostn){if(isset($_POST['ip']) && $_POST['ip']=='on')echo ' checked="checked"';}elseif($options['show_column_sfile']["ip"]) echo ' checked="checked"'; ?>><label for="ip">&nbsp;Show IP</label></li>
</div>
</td>
...
<tr>
<td class="tdacc"><input type="checkbox" id="bandwidthsave" name="bandwidthsave"<?php if($showpostn){if(isset($_POST['bandwidthsave']) && $_POST['bandwidthsave']=='on')echo ' checked="checked"';}elseif($options['bw_save']) echo ' checked="checked"'; ?>><label for="bandwidthsave">&nbsp;Bandwidth saving</label></td>
<td class="tdacc">To save bandwidth, if the file name is exist, then stop leeching</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id="deletelink_in_lynx" name="deletelink_in_lynx"<?php if($showpostn){if(isset($_POST['deletelink_in_lynx']) && $_POST['deletelink_in_lynx']=='on')echo ' checked="checked"';}elseif($options['deletelink_in_lynx']) echo ' checked="checked"'; ?>><label for="deletelink_in_lynx">&nbsp;Show Delete Link (lynx.php)</label></td>
...
<tr>
<td class="tdacc"><input type="checkbox" id="showcpanel" name="showcpanel"<?php if($showpostn){if(isset($_POST['showcpanel']) && $_POST['showcpanel']=='on')echo ' checked="checked"';}elseif($options['navi_left']["showcpanel"]) echo ' checked="checked"'; ?>><label for="showcpanel">&nbsp;Show Cpanel button</label></td>
<td class="tdacc">Show CPanel button</td>
</tr>
<tr>
<td class="tdacc"><label for="showplugins"><input type="checkbox" id="showplugins" name="showplugins"<?php if($showpostn){if(isset($_POST['showplugins']) && $_POST['showplugins']=='on')echo ' checked="checked"';}elseif($options['navi_left']["showplugins"]) echo ' checked="checked"'; ?>>&nbsp;Show Plugins list</label></td>
...
<input type="checkbox" id="forbid_audl" name="forbid_audl"<?php if($showpostn){if(isset($_POST['forbid_audl']) && $_POST['forbid_audl']=='on')echo ' checked="checked"';}elseif($options['forbid_audl']) echo ' checked="checked"'; ?>>&nbsp;*&nbsp;Forbidden to AuDL</label>
</div>
</td>
...
<input type="checkbox" id="forbid_auul" name="forbid_auul"<?php if($showpostn){if(isset($_POST['forbid_auul']) && $_POST['forbid_auul']=='on')echo ' checked="checked"';}elseif($options['forbid_auul']) echo ' checked="checked"'; ?>>&nbsp;*&nbsp;Forbidden to AuUL</label>
</div>
</td>
...
<div style="padding-left:15px;">
            <input type="checkbox" id="forbid_lynx" name="forbid_lynx"<?php if($showpostn){if(isset($_POST['forbid_lynx']) && $_POST['forbid_lynx']=='on')echo ' checked="checked"';}elseif($options['forbid_lynx']) echo ' checked="checked"'; ?>/>
...
<td class="tdacc">
<label for="showmtn">
<input type="checkbox" id="showmtn" name="showmtn" onclick="var displ=this.checked?'':'none';d.getElementById('video_option').style.display=displ;" <?php if($showpostn) {if (isset($_POST['showmtn']) && $_POST['showmtn'] == 'on')echo 'checked';} elseif ($options['navi_left']['showmtn']){echo ' checked="checked"';}?>>&nbsp; Show Movie Thumbnailer</label></td>
...
<div style="padding-left:15px;">
<input type="checkbox" id="cpuUsageNFO" name="cpuUsageNFO"<?php if($showpostn){if(isset($_POST['cpuUsageNFO']) && $_POST['cpuUsageNFO']=='on')echo ' checked="checked"';}elseif($options['cpuUsageNFO']) echo ' checked="checked"'; ?>><label for="cpuUsageNFO">&nbsp;Show CPU Usage</label>
</div>
</td>
...
<tr>
<td class="tdacc"><input type="checkbox" id="onlinevisit" name="onlinevisit"<?php if($showpostn){if(isset($_POST['onlinevisit']) && $_POST['onlinevisit']=='on')echo ' checked="checked"';}elseif($options['OnlineVisitor']) echo ' checked="checked"'; ?>><label for="onlinevisit">&nbsp;Show Online Visitor</label></td>
...
<tr>
<td class="tdacc"><input type="checkbox" id=nocache name="nocache"<?php if($showpostn){if(isset($_POST['nocache']) && $_POST['nocache']=='on')echo ' checked="checked"';}elseif($options['no_cache']) echo ' checked="checked"'; ?>><label for=nocache>&nbsp;No cache page</label></td>
<td class="tdacc">Prohibition by Browser (You should leave this checked unless you know what you are doing)</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id=redirrect name="redirrect"<?php if($showpostn){if(isset($_POST['redirrect']) && $_POST['redirrect']=='on')echo ' checked="checked"';}elseif($options['redir']) echo ' checked="checked"'; ?>><label for=redirrect>&nbsp;Redirrect</label></td>
<td class="tdacc">Redirect passive method (You should leave this checked unless you know what you are doing)</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id=disable_ajax name="disable_ajax"<?php if($showpostn){if(isset($_POST['disable_ajax']) && $_POST['disable_ajax']=='on')echo ' checked="checked"';}elseif($options['disable_ajax']) echo ' checked="checked"'; ?>><label for=disable_ajax>&nbsp;Disable Ajax</label></td>
<td class="tdacc">Do not use Ajax in Serverfiles.</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id=disable_ajaxren name="disable_ajaxren"<?php if($showpostn){if(isset($_POST['disable_ajaxren']) && $_POST['disable_ajaxren']=='on')echo ' checked="checked"';}elseif($options['disable_ajaxren']) echo ' checked="checked"'; ?>><label for=disable_ajaxren>&nbsp;Disable Instant-Rename</label></td>
<td class="tdacc">Do not load Ajax Instant-Rename. <small>require: rsajax.js</small></td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id=logact name="logact"<?php if($showpostn){if(isset($_POST['logact']) && $_POST['logact']=='on')echo ' checked="checked"';}elseif($options['logact']) echo ' checked="checked"'; ?>><label for=logact>&nbsp;User-Log Activity</label></td>
<td class="tdacc">Record IP, Browser, Refferer; time access of the users</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id=alternatefree name="alternatefree"<?php if($showpostn){if(isset($_POST['alternatefree']) && $_POST['alternatefree']=='on')echo ' checked="checked"';}elseif($options['alternatefree']) echo ' checked="checked"'; ?>><label for=alternatefree>&nbsp;Alternate switch to freedownload</label></td>
<td class="tdacc">Auto switch to free download if premium not available</td>
</tr>
<tr>
<td class="tdacc"><input type="checkbox" id="auto_cl" name="auto_cl" onclick="var displ=this.checked?'':'none';document.getElementById('line_autClket').style.display=displ;"<?php if($showpostn){if(isset($_POST['auto_cl']) && $_POST['auto_cl']=='on')echo ' checked="checked"';}elseif($options['autoclose']) echo ' checked="checked"'; ?>><label for="auto_cl">&nbsp;Auto-close audl popup</label></td>
...
<tr>
<td class="tdacc"><input type="checkbox" id=autochecklink name="autochecklink"<?php if($showpostn){if(isset($_POST['autochecklink']) && $_POST['autochecklink']=='on')echo ' checked="checked"';}elseif($options['autochecklink']) echo ' checked="checked"'; ?>><label for=autochecklink>&nbsp;Auto-Check Link</label></td>
<td class="tdacc">Auto check submited link in audl</td>
</tr>

<tr>
<td class="tdacc"><input type="checkbox" id=mip_enabled name="mip_enabled" onclick="var displ=this.checked?'':'none';document.getElementById('line_mip').style.display=displ;"<?php if($showpostn){if(isset($_POST['mip_enabled']) && $_POST['mip_enabled']=='on')echo ' checked="checked"';}elseif($options['mip_enabled']) echo ' checked="checked"'; ?>/><label for=mip_enabled>&nbsp;Enable Multi-IP</label></td>
<td class="tdacc">Enable Multi-IP based on mip_iplist.txt</td>
</tr>
<tr id="line_mip" style="display:<?php echo ($options['mip_enabled']? '':'none');?>">
<td class="tdacc float" ><div style="padding-left:20px;">
<input type="checkbox" name="mip_arotate" id="mip_arotate"<?php if($showpostn){if(isset($_POST['mip_arotate']) && $_POST['mip_arotate']=='on')echo ' checked="checked"';}elseif($options['mip_arotate']) echo ' checked="checked"'; ?>>&nbsp;<label for=mip_arotate>IP-Rotate</label><div style="height:3px;"></div>
...
<tr>
<td class="tdacc">
<input type="checkbox" id="usepcc" name="usepcc" onclick="displ=this.checked?'':'none';document.getElementById('divpccL').style.display=displ;" <?php if($showpostn){if(isset($_POST['usepcc']) && $_POST['usepcc']=='on')echo ' checked="checked"';}elseif((isset($premium_acc)) && $ada_acc) echo ' checked="checked"';?>><label for=usepcc><b>Use premiX acc</b></label>
&nbsp;&nbsp;&nbsp;
<input type="checkbox" id="autodlpremix" name="autodlpremix" <?php if($showpostn){if(isset($_POST['autodlpremix']) && $_POST['autodlpremix']=='on')echo ' checked="checked"';}elseif((isset($premium_acc))&&(isset($premium_acc_audl))&&$premium_acc_audl) echo ' checked="checked"'; ?>><label for="autodlpremix" title="Enable Premix on Audl">Enable on Audl</label>
</td>
...
<?php 
	...
	if($showpostn){
	 if(isset($_POST['rs_com_premix']) && $_POST['rs_com_premix']=='on')
	  {$chk=' checked="checked"';$rsencchecked=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['rs_de_premix']) && $_POST['rs_de_premix']=='on')
    {$chk= ' checked="checked"';$rsdechecked=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['4shared_premix']) && $_POST['4shared_premix']=='on')
    {$chk= ' checked="checked"';$d4shared=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['animeground_premix']) && $_POST['animeground_premix']=='on')
    {$chk= ' checked="checked"';$animeground=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['bitshare_premix']) && $_POST['bitshare_premix']=='on')
    {$chk= ' checked="checked"';$bitshare=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['depositfiles_premix']) && $_POST['depositfiles_premix']=='on')
    {$chk= ' checked="checked"';$depositfiles=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['crocko_premix']) && $_POST['crocko_premix']=='on')
    {$chk= ' checked="checked"';$crocko=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['enterupload_premix']) && $_POST['enterupload_premix']=='on')
    {$chk= ' checked="checked"';$enterupload=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['fileape_premix']) && $_POST['fileape_premix']=='on')
    {$chk= ' checked="checked"';$fileape=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['filedino_premix']) && $_POST['filedino_premix']=='on')
    {$chk= ' checked="checked"';$filedino=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['filedude_premix']) && $_POST['filedude_premix']=='on')
    ...
    {$chk= ' checked="checked"';$filedude=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['filefactory_premix']) && $_POST['filefactory_premix']=='on')
    {$chk= ' checked="checked"';$filefactory=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['fileserve_premix']) && $_POST['fileserve_premix']=='on')
    {$chk= ' checked="checked"';$fileserve=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['filesonic_premix']) && $_POST['filesonic_premix']=='on')
    {$chk= ' checked="checked"';$filesonic=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['freakshare_premix']) && $_POST['freakshare_premix']=='on')
    {$chk= ' checked="checked"';$freakshare=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['gigasize_premix']) && $_POST['gigasize_premix']=='on')
    {$chk= ' checked="checked"';$gigasize=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['hellshare_premix']) && $_POST['hellshare_premix']=='on')
    {$chk= ' checked="checked"';$hellshare=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['hotfile_premix']) && $_POST['hotfile_premix']=='on')
    {$chk= ' checked="checked"';$hotfile=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['ifile_premix']) && $_POST['ifile_premix']=='on')
    {$chk= ' checked="checked"';$ifile=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['kickload_premix']) && $_POST['kickload_premix']=='on')
    {$chk= ' checked="checked"';$kickload=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['letitbit_premix']) && $_POST['letitbit_premix']=='on')
    {$chk= ' checked="checked"';$letitbit=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['megashare_premix']) && $_POST['megashare_premix']=='on')
    {$chk= ' checked="checked"';$megashare=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['megashares_premix']) && $_POST['megashares_premix']=='on')
    {$chk= ' checked="checked"';$megashares=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['megaupload_premix']) && $_POST['megaupload_premix']=='on')
    {$chk= ' checked="checked"';$megaupload=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['netload_premix']) && $_POST['netload_premix']=='on')
    {$chk= ' checked="checked"';$netload=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['sendspace_premix']) && $_POST['sendspace_premix']=='on')
    {$chk= ' checked="checked"';$sendspace=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['shareonline_premix']) && $_POST['shareonline_premix']=='on')
    {$chk= ' checked="checked"';$shareonline=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['torrific_premix']) && $_POST['torrific_premix']=='on')
    {$chk= ' checked="checked"';$torrific=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['turbobit_premix']) && $_POST['turbobit_premix']=='on')
    {$chk= ' checked="checked"';$turbobit=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['ugotfile_premix']) && $_POST['ugotfile_premix']=='on')
    {$chk= ' checked="checked"';$ugotfile=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['uploaded_premix']) && $_POST['uploaded_premix']=='on')
    {$chk= ' checked="checked"';$uploaded=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['uploading_premix']) && $_POST['uploading_premix']=='on')
    {$chk= ' checked="checked"';$uploading=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['uploadstation_premix']) && $_POST['uploadstation_premix']=='on')
    {$chk= ' checked="checked"';$uploadstation=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['vBulletin_premix']) && $_POST['vBulletin_premix']=='on')
    {$chk= ' checked="checked"';$vbulletin=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['wupload_premix']) && $_POST['wupload_premix']=='on')
    {$chk= ' checked="checked"';$wupload=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['youtube_premix']) && $_POST['youtube_premix']=='on')
    {$chk= ' checked="checked"';$youtube=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['muhash_premix']) && $_POST['muhash_premix']=='on')
    {$chk= ' checked="checked"';$megcook=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['hfhash_premix']) && $_POST['hfhash_premix']=='on')
    {$chk= ' checked="checked"';$hfcook=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['rshash_premix']) && $_POST['rshash_premix']=='on')
    {$chk= ' checked="checked"';$rscook=true;}
...
<?php 
  ...
  if($showpostn){
   if(isset($_POST['ulhash_premix']) && $_POST['ulhash_premix']=='on')
    {$chk= ' checked="checked"';$ulcook=true;}
...
<?php 
  ...
  if($showpostn){
    if(isset($_POST['imghack_premix']) && $_POST['imghack_premix']=='on')
	 {$chk= ' checked="checked"';$img_hackt=true;}
...
<?php 
 ...
 if($showpostn){
   if(isset($_POST['mediafire_up_upload']) && $_POST['mediafire_up_upload']=='on')
    {$chk= ' checked="checked"';$mf_up=true;}
...
<?php 
  ...
  if($showpostn){
    if(isset($_POST['rs_com_coll_upload']) && $_POST['rs_com_coll_upload']=='on')
	 {$chk= ' checked="checked"';$rs_com_coll_up=true;}
...
<?php 
  ...
  if($showpostn){
    if(isset($_POST['rs_com_pre_upload']) && $_POST['rs_com_pre_upload']=='on')
	  {$chk= ' checked="checked"';$rs_com_pre_up=true;}
...
<?php 
  ...
  if($showpostn){
    if(isset($_POST['mu_pre_upload']) && $_POST['mu_pre_upload']=='on')
	  {$chk= ' checked="checked"';$mu_pre_up=true;}
...
<?php
  ...
  if($showpostn){
    if(isset($_POST['mu_mem_upload']) && $_POST['mu_mem_upload']=='on')
	  {$chk= ' checked="checked"';$mu_mem_up=true;}
...
<?php 
  ...
  if($showpostn){
    if(isset($_POST['hf_com_upload']) && $_POST['hf_com_upload']=='on')
	  {$chk= ' checked="checked"';$hf_com_up=true;}
  ...
  $easysh_mem_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['easysh_mem_upload']) && $_POST['easysh_mem_upload']=='on')
	  {$chk= ' checked="checked"';$easysh_mem_up=true;}
  ...
  $deposit_up_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['deposit_up_upload']) && $_POST['deposit_up_upload']=='on')
	  {$chk= ' checked="checked"';$deposit_up_up=true;}
  ...
  $uploading_up_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['uploading_up_upload']) && $_POST['uploading_up_upload']=='on')
	  {$chk= ' checked="checked"';$uploading_up_up=true;}
  ...
  $fileserve_pre_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['fileserve_pre_upload']) && $_POST['fileserve_pre_upload']=='on')
	  {$chk= ' checked="checked"';$fileserve_pre_up=true;}
  ...
  $fileserve_mem_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['fileserve_mem_upload']) && $_POST['fileserve_mem_upload']=='on')
	  {$chk= ' checked="checked"';$fileserve_mem_up=true;}
  ...
  $ul_up_up=false;$chk='';
   if($showpostn){
     if(isset($_POST['ul_up_upload']) && $_POST['ul_up_upload']=='on')
	  {$chk= ' checked="checked"';$ul_up_up=true;}
...
<td class="tdacc"><span class='b'>WARNING..!</span><b>IF THIS IS NOT SET BEFORE YOU USE PREMIUM SERVICES, YOU WILL BE WARNED BY THE RAPIDLEECH SCRIPT. OTHERWISE YOUR PREMIUM ACCOUNTS AND/OR COOKIES COULD BE COMPROMISED!</b></td>
</tr>
