...
'list_allow_ip' => '127.0.0.1', // White list ip. eg. 111.111.111.111, 255.*.*.*  //--never blank this shit if you set $options['limited_edition' => true 
...
((!function_exists('exec')&&!function_exists('shell_exec')) ? $options['CpuLoadFormat'] = 'percent':null), //CpuLoadFormat must be in percent mode if required functions is not exists
...
'showautoclose' => false,//autoclose popup when leeching in audl
'timeautoclose' => 250,
