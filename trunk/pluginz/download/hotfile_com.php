...
class hotfile_com extends DownloadClass {
    ...
    public function Download($link) {
        ...
        } elseif ($_REQUEST["premium_acc"] == "on" && (($_GET["maudl"] == 'multi' && !empty($_GET["auth_hash"])) || (!empty($_REQUEST["premium_user"]) && !empty($_REQUEST["premium_pass"])) || (!empty($premium_acc["hotfile"]['user']) && !empty($premium_acc["hotfile"]['pass'])))) {
