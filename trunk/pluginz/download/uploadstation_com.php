...
class uploadstation_com extends DownloadClass {
    ...
    public function Download($link) {
        ...
        $this->link = $link;
        if (($_REQUEST["premium_acc"] == "on" && $_REQUEST["premium_user"] && $_REQUEST["premium_pass"]) || ($_REQUEST["premium_acc"] == "on" && $premium_acc["uploadstation"]["user"] && $premium_acc["uploadstation"]["pass"])) {
    ...
    private function Login() {
        ...
        $user = ($pA ? $_REQUEST["premium_user"] : $premium_acc["uploadstation"]["user"]);
        $pass = ($pA ? $_REQUEST["premium_pass"] : $premium_acc["uploadstation"]["pass"]);
