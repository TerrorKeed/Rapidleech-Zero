...
class enterupload_com extends DownloadClass {
    ...
    public function Download($link) {
        ...
        if (($_REQUEST ["premium_acc"] == "on" && $_REQUEST ["premium_user"] && $_REQUEST ["premium_pass"]) ||
           ($_REQUEST ["premium_acc"] == "on" && $premium_acc ["enterupload"] ["user"] && $premium_acc ["enterupload"] ["pass"])) {
    ...
    private function DownloadPremium($link) {
        ...
        $post['op'] = "login";
        $post['redirect'] = "";
        $post['login'] = $_REQUEST["premium_user"] ? trim($_REQUEST["premium_user"]) : $premium_acc ["enterupload"] ["user"];
        $post['password'] = $_REQUEST["premium_pass"] ? trim($_REQUEST["premium_pass"]) : $premium_acc ["enterupload"] ["pass"];
        $post['x'] = rand(0,50);
        $post['y'] = rand(0,12);
