...
class torrific_com extends DownloadClass {
    ...
    public function Download($link) {
        ...
        } elseif (( $_REQUEST ["premium_acc"] == "on" && $_REQUEST ["premium_user"] && $_REQUEST ["premium_pass"] ) || ( $_REQUEST ["premium_acc"] == "on" && $premium_acc ["torrific"] ["user"] && $premium_acc ["torrific"] ["pass"] )) {
    ...
    private function displayLinks($link) {
        ...
        if (isset($user) && isset($pass)) {
            ...
            $user = $_REQUEST ["premium_user"] ? $_REQUEST ["premium_user"] : $premium_acc ["torrific"] ["user"];
            $password = $_REQUEST ["premium_pass"] ? $_REQUEST ["premium_pass"] : $premium_acc ["torrific"] ["pass"];
        }
...
/**********************torrific.com*****************************************************\
  ...
  Fixed and Updated by Raj Malhotra on 20 Nov 2010
  Updated by Raj Malhotra on 5 Jan 2011
  Minor fix with added countdown so the link can be downloaded by Ruud v.Tony 22 Sept 2011
\**********************torrific.com*****************************************************/
?>