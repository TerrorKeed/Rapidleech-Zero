...
} elseif (isset($upload_acc) && isset($upload_acc["ul_up"]["user"]) && $upload_acc["ul_up"]["user"] != '' && $upload_acc["ul_up"]["pass"] != '') {
    $_REQUEST['my_login'] = $upload_acc["ul_up"]["user"];
    $_REQUEST['my_pass'] = $upload_acc["ul_up"]["pass"];
    $_REQUEST['action'] = "FORM";
    echo "<b><center>Use Default login/pass.</center></b>\n";
}
