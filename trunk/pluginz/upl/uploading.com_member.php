...
####### Free Account Info. ###########
$uploading_username = $upload_acc["uploading_up"]["user"]; 
$uploading_password = $upload_acc["uploading_up"]["pass"]; 
##############################

$not_done=true;
$continue_up=false;
if ($uploading_username & $uploading_password){
	$_REQUEST['login'] = $uploading_username;
	$_REQUEST['pwd'] = $uploading_password;
