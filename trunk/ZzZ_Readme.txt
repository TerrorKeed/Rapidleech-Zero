...
* [FEATURE] Add Movie Thumbnailer - Sakib, Slider324, jmsmarcello
* [FEATURE] Recoded config.php, xpanel.php, xpanelform.php, other.php, index.php for Movie Thumbnailer support - Darknight (sorry for makin' u trouble, thx :D)
* [FEATURE] Fix language - Idoenx, Se7en.7x
...
* [PLUGIN] Added some newly upload plugin for new filehost - Th3-882,  Vinhatrang_LV, Shy2ply, Nastrove/Defport
...
* Additional note for Idoenx : wb :maho:
