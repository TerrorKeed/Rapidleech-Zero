...
?>
    <div id="rar_debug<?php echo $debug_id; ?>" style="padding:2px;position:absolute; top:<?php echo (intval($debug_id)*24)+2; ?>px; left:10px; background:#082330; border:2px solid #666666; text-align: left;">
      <b>Plusrar Debug Window<?php echo (!$this->debug ? '('.$optxt['rar_error'].'), ' : '')?></b>&nbsp;&nbsp;&nbsp;&nbsp;<span onclick="javascript:$('#rar_debug_contents<?php echo $debug_id; ?>').toggle();">(<?php echo $optxt['rar_expand']; ?>)</span>
...
?></textarea>
        <br />
        <input type="button" value="<?php echo $optxt['_text']; ?>" onclick="javascript:document.getElementById('rar_debug_text<?php echo $debug_id; ?>').focus();document.getElementById('rar_debug_text<?php echo $debug_id; ?>').select();" />
        <div class="dragzone" style="text-align: center;font-weight: bold">&nbsp;<br /><?php echo $optxt['rar_window']; ?><br />&nbsp;</div>
      </div>
  </div>
