...
$ar_chkbox_acc = array(
    ...
    'filedino_premix',
    'filedude_premix',
    'filefactory_premix', // index = 10
    'fileserve_premix',
    'filesonic_premix',
    'freakshare_premix',
    'gigasize_premix',
    'hellshare_premix', // index = 15
    'hotfile_premix',
    'ifile_premix',
    'kickload_premix',
    'letitbit_premix',
    'megashare_premix',
    'megashares_premix', // index = 20
    'megaupload_premix',
    'netload_premix',
    'oron_premix',
    'sendspace_premix',
    'shareonline_premix', // index = 25
    'torrific_premix',
    'turbobit_premix',
    'ugotfile_premix',
    'uploaded_premix',
    'uploading_premix', // index = 30
    'uploadstation_premix',
    'vBulletin_premix',
    'wupload_premix',
    'x7_premix',
    'youtube_premix',
        ...
        if (!$accchange) { // no new acc, grab from config
            switch ($fpar) {
                ...
                case 'rshash_premix':
                    ...
                    break;
                case 'ulhash_premix':
                    global $ul_cookie_login_value;
                    $_POST[$fu] = $ul_cookie_login_value;
                    break;
                case 'imghack_premix':
    ...
    if (isset($_POST['submit'])) {
        if ($task == 'editor') {
            ...
            if (isset($_POST['usepcc']) && $_POST['usepcc'] == 'on') {
                ...
                fieldfilter($ar_chkbox_acc[2], 'usr4shared', 'pass4shared', $badpetik);
                ...
                fieldfilter($ar_chkbox_acc[10], 'usrfiledude', 'passfiledude', $badpetik);
                fieldfilter($ar_chkbox_acc[11], 'usrfilefactory', 'passfilefactory', $badpetik);
                fieldfilter($ar_chkbox_acc[12], 'usrfileserve', 'passfileserve', $badpetik);
                fieldfilter($ar_chkbox_acc[13], 'usrfilesonic', 'passfilesonic', $badpetik);
                fieldfilter($ar_chkbox_acc[14], 'usrfreakshare', 'passfreakshare', $badpetik);
                fieldfilter($ar_chkbox_acc[15], 'usrgigasize', 'passgigasize', $badpetik);
                fieldfilter($ar_chkbox_acc[16], 'usrhellshare', 'passhellshare', $badpetik);
                fieldfilter($ar_chkbox_acc[17], 'usrhotfile', 'passhotfile', $badpetik);
                fieldfilter($ar_chkbox_acc[18], 'usrifile', 'passifile', $badpetik);
                fieldfilter($ar_chkbox_acc[19], 'usrkickload', 'passkickload', $badpetik);
                fieldfilter($ar_chkbox_acc[20], 'usrletitbit', 'passletitbit', $badpetik);
                fieldfilter($ar_chkbox_acc[21], 'usrmegashare', 'passmegashare', $badpetik);
                fieldfilter($ar_chkbox_acc[22], 'usrmegashares', 'passmegashares', $badpetik);
                fieldfilter($ar_chkbox_acc[23], 'usrmegaupload', 'passmegaupload', $badpetik);
                fieldfilter($ar_chkbox_acc[24], 'usrnetload', 'passnetload', $badpetik);
                fieldfilter($ar_chkbox_acc[25], 'usroron', 'passoron', $badpetik);
                fieldfilter($ar_chkbox_acc[26], 'usrsendspace', 'passsendspace', $badpetik);
                fieldfilter($ar_chkbox_acc[27], 'usrshareonline', 'passshareonline', $badpetik);
                fieldfilter($ar_chkbox_acc[28], 'usrtorrific', 'passtorrific', $badpetik);
                fieldfilter($ar_chkbox_acc[29], 'usrturbobit', 'passturbobit', $badpetik);
                fieldfilter($ar_chkbox_acc[30], 'usrugotfile', 'passugotfile', $badpetik);
                fieldfilter($ar_chkbox_acc[31], 'usruploaded', 'passuploaded', $badpetik);
                fieldfilter($ar_chkbox_acc[32], 'usruploading', 'passuploading', $badpetik);
                fieldfilter($ar_chkbox_acc[33], 'usruploadstation', 'passuploadstation', $badpetik);
                fieldfilter($ar_chkbox_acc[34], 'usrvbulletin', 'passvbulletin', $badpetik);
                fieldfilter($ar_chkbox_acc[35], 'usrwupload', 'passwupload', $badpetik);
                fieldfilter($ar_chkbox_acc[36], 'usrx7', 'passx7', $badpetik);
                fieldfilter($ar_chkbox_acc[37], 'usryoutube', 'passyoutube', $badpetik);
            } //-- end $_POST['usepcc']
            else {
            ...
            singlefilter('ulhash_premix', 'ulhashcookie', '', $badpetik);
            ...
            $field = array(
                ...
                'filedude_premix' => array('filedude', 'usrfiledude', 'passfiledude'),
                'filefactory_premix' => array('filefactory', 'usrfilefactory', 'passfilefactory'),
                'fileserve_premix' => array('fileserve', 'usrfileserve', 'passfileserve'),
                'filesonic_premix' => array('filesonic', 'usrfilesonic', 'passfilesonic'),
                'freakshare_premix' => array('freakshare', 'usrfreakshare', 'passfreakshare'),
                'gigasize_premix' => array('gigasize', 'usrgigasize', 'passgigasize'),
                'hellshare_premix' => array('hellshare', 'usrhellshare', 'passhellshare'),
                'hotfile_premix' => array('hotfile', 'usrhotfile', 'passhotfile'),
                'ifile_premix' => array('ifile', 'usrifile', 'passifile'),
                'kickload_premix' => array('kickload', 'usrkickload', 'passkickload'),
                'letitbit_premix' => array('letitbit', 'usrletitbit', 'passletitbit'),
                'megashare_premix' => array('megashare', 'usrmegashare', 'passmegashare'),
                'megashares_premix' => array('megashares', 'usrmegashares', 'passmegashares'),
                'megaupload_premix' => array('megaupload', 'usrmegaupload', 'passmegaupload'),
                'netload_premix' => array('netload', 'usrnetload', 'passnetload'),
                'oron_premix' => array('oron', 'usroron', 'passoron'),
                'sendspace_premix' => array('sendspace', 'usrsendspace', 'passsendspace'),
                'shareonline_premix' => array('shareonline', 'usrshareonline', 'passshareonline'),
                'torrific_premix' => array('torrific', 'usrtorrific', 'passtorrific'),
                'turbobit_premix' => array('turbobit', 'usrturbobit', 'passturbobit'),
                'ugotfile_premix' => array('ugotfile', 'usrugotfile', 'passugotfile'),
                'uploaded_premix' => array('uploaded', 'usruploaded', 'passuploaded'),
                'uploading_premix' => array('uploading', 'usruploading', 'passuploading'),
                'uploadstation_premix' => array('uploadstation', 'usruploadstation', 'passuploadstation'),
                'vBulletin_premix' => array('vBulletin', 'usrvbulletin', 'passvbulletin'),
                'wupload_premix' => array('wupload', 'usrwupload', 'passwupload'),
                'x7_premix' => array('x7', 'usrx7', 'passx7'),
                'youtube_premix' => array('youtube', 'usryoutube', 'passyoutube'),
            );
            ...
            $_config .= "#Uploaded cookie #\n";
            $_config .= ( isset($_POST['ulhash_premix']) && $_POST['ulhash_premix'] == 'on' ? '' : '//') . "\$ul_cookie_login_value = '" . addslashes(trim($_POST['ulhashcookie'])) . "';\n\n";
            ...
            $_config .= "'filedude'		=>  'filedude.com',\n";
            $_config .= "'filefactory'		=>  'filefactory.com',\n";
            $_config .= "'fileserve'      	=>  'fileserve.com',\n";
            $_config .= "'filesonic'      	=>  'filesonic.com',\n";
            $_config .= "'freakshare'     	=>  'freakshare.com',\n";
            $_config .= "'gigasize'       	=>  'gigasize.com',\n";
            $_config .= "'hellshare'      	=>  'hellshare.com',\n";
            $_config .= "'hotfile'        	=>  'hotfile.com',\n";
            $_config .= "'ifile'          	=>  'ifile.it',\n";
            $_config .= "'kickload'       	=>  'kickload.com',\n";
            $_config .= "'letitbit'       	=>  'letitbit.net',\n";
            $_config .= "'megashare'      	=>  'megashare.com',\n";
            $_config .= "'megashares'     	=>  'megashares.com',\n";
            $_config .= "'megaupload'     	=>  'megaupload.com',\n";
            $_config .= "'netload'        	=>  'netload.in',\n";
            $_config .= "'oron'           	=>  'oron.com',\n";
            $_config .= "'sendspace'      	=>  'sendspace.com',\n";
            $_config .= "'shareonline'    	=>  'share-online.biz',\n";
            $_config .= "'torrific'       	=>  'torrific.com',\n";
            $_config .= "'turbobit'       	=>  'turbobit.net',\n";
            $_config .= "'ugotfile'       	=>  'ugotfile.com',\n";
            $_config .= "'uploaded'       	=>  'uploaded.to',\n";
            $_config .= "'uploading'      	=>  'uploading.com',\n";
            $_config .= "'uploadstation'  	=>  'uploadstation.com',\n";
            $_config .= "'vBulletin'      	=>  'vbulletin.acc',\n";
            $_config .= "'wupload'        	=>  'wupload.com',\n";
            $_config .= "'x7'             	=>  'x7.to',\n";
